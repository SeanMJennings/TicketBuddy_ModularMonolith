...
using System.Linq;
using Architecture.Notifications.ProjectDependencies.Rules;
...
public sealed class ProjectDependenciesGuardian : DiagnosticAnalyzer
{
    ...
    private static void Analyze(CompilationAnalysisContext context)
    {
        ...
        var referencedAssemblies = AssemblyReferenceReader.GetReferencedProjectAssemblies(context.Compilation, KnownAssemblies.IsKnownAssembly);
