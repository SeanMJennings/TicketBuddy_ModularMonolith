...
import {
    ...
    should_render_protected_content_for_authorized_user_of_any_type, renders_loading_when_loading
...
describe("ProtectedRoute", () => {
    ...
    it("renders loading when loading", renders_loading_when_loading);
});
