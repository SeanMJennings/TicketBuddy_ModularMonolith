CREATE TABLE "Event"."InboxState" (
    ...
    CONSTRAINT "PK_InboxState_Event" PRIMARY KEY ("Id"),
    CONSTRAINT "AK_InboxState_Event_MessageId_ConsumerId" UNIQUE ("MessageId", "ConsumerId")
);

CREATE TABLE "Event"."OutboxMessage" (
    ...
    "ExpirationTime" timestamptz NULL,
    CONSTRAINT "PK_OutboxMessage_Event" PRIMARY KEY ("SequenceNumber")
);

CREATE TABLE "Event"."OutboxState" (
    ...
    "Delivered" timestamptz NULL,
    "LastSequenceNumber" bigint NULL,
    CONSTRAINT "PK_OutboxState_Event" PRIMARY KEY ("OutboxId")
);